...
EVENT_LAST_CANCEL_DATE_COL = 15
EVENT_LOCATION_COL = 7
EVENT_MAX_ATTENDEES_COL = 6
EVENT_NAME_COL = 1
EVENT_ORGANIZER_AS_ATTENDEE_COL = 16
...
ATTENDEE_BADGE_NUMBER_COL = 3
ATTENDEE_RECEIPT_ID_COL = 4
ATTENDEE_RECEIPT_URL_COL = 6
ATTENDEE_RECEIPT_NUM_COL = 5

FREE_RECEIPT_URL = '/static/free.html'
FREE_EVENT_RECEIPT = 'free'
FREE_RECEIPT_ID = '0'